...
function siguientePregunta(expediente) {
    switch (expediente.paso_actual) {
        ...
        case "FECHA":
            return "¿En qué fecha se realizó la compraventa? Puedes escribirla como 14/08/2026.";
        ...
        case "PRIMERA_MATRICULACION":
            return "¿Cuál es la fecha de primera matriculación del vehículo?";

        case "COMBUSTIBLE":
            return "¿Qué combustible utiliza el vehículo?";

        case "CILINDRADA":
            return "¿Cuál es la cilindrada en cc?";

        case "POTENCIA":
            return "¿Cuál es la potencia? Indica también kW o CV.";
        ...
        case "CARROCERIA_FISCAL":
            return "¿El vehículo es normal/cerrado o descapotable/cabrio?";

        case "TRANSMISION_FISCAL":
            return "¿El cambio es manual o secuencial/automático?";

        case "VERSION_EXACTA":
            return "Indícame la versión exacta tal como aparece en la documentación.";

        case "TIPO_VENDEDOR":
            return "¿Lo compras a un particular o a una empresa/profesional que te entrega factura?";
        ...
        case "PAGO_PENDIENTE":
            return "El cálculo está terminado.";
...
async function procesarIdentificacion(
    ...
    if (candidatos.length === 0) {
        return {
            paso: "VERSION_EXACTA",
            respuesta:
                "No he podido identificar la versión exacta. Escríbeme la versión tal como aparece en la documentación."
        };
    }
    ...
    if (candidatos.length === 1) {
        ...
        return {
            ...
            vehiculo,
            respuesta:
                `Perfecto. He identificado el vehículo como ${vehiculo.marca} ${vehiculo.modelo_tipo}. ¿Lo compras a un particular o a una empresa/profesional que te entrega factura?`
        };
    }
    ...
    if (
        ...
        return {
            paso,
            respuesta:
                "Necesito distinguir la versión exacta. ¿El vehículo es normal/cerrado o descapotable/cabrio?"
        };
    }
    ...
    if (
        ...
        return {
            paso,
            respuesta:
                "Perfecto. Ahora necesito saber si el cambio es manual o secuencial/automático."
        };
    }
...
export default async function handler(req, res) {
    ...
    try {
        ...
        /* =================================================
           CASOS DE IDENTIFICACIÓN QUE DEBEN
           REEJECUTAR LA BÚSQUEDA DESPUÉS DE GUARDAR
        ================================================= */
        ...
        if (
            ...
            if (
                ...
                errorValidacion =
                    "Respóndeme normal/cerrado o descapotable/cabrio.";
            }
        ...
        if (
            ...
            if (
                ...
                errorValidacion =
                    "Respóndeme manual o secuencial/automático.";
            }
        ...
        switch (
            ...
            case "PRECIO": {
                ...
                if (
                    ...
                    errorValidacion =
                        "Indícame el precio de compraventa.";
                } else {
            ...
            case "POTENCIA": {
                ...
                if (!potencia) {
                    ...
                    errorValidacion =
                        "Indícame si la potencia está en kW o CV.";
            ...
            case "TIPO_VENDEDOR": {
                ...
                if (
                    ...
                    errorValidacion =
                        "Respóndeme particular o empresa/profesional.";
                }
            ...
            case "FACTURA_PENDIENTE":
                ...
                return res.status(200).json({
                    ok: true,
                    respuesta:
                        "La factura está pendiente de verificación.",
                    paso_actual:
                        "FACTURA_PENDIENTE",
                    requiere_factura:
                        true
